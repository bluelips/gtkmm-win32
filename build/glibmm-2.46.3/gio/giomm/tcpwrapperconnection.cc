...
:
  ...
  Glib::ObjectBase(0),
  Gio::TcpConnection(Glib::ConstructParams(tcpwrapperconnection_class_.init(), "base_io_stream", Glib::unwrap(base_io_stream), "socket", const_cast<GSocket*>(Glib::unwrap(socket)), static_cast<char*>(0)))
{
