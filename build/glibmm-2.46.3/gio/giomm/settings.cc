...
:
  ...
  Glib::ObjectBase(0),
  Glib::Object(Glib::ConstructParams(settings_class_.init(), "schema_id", schema_id.c_str(), static_cast<char*>(0)))
{
...
:
  // Mark this class as non-derived to allow C++ vfuncs to be skipped.
  Glib::ObjectBase(0),
  Glib::Object(Glib::ConstructParams(settings_class_.init(), "schema_id", schema_id.c_str(), "path", path.c_str(), static_cast<char*>(0)))
{
...
Glib::SignalProxyDetailed1< void,const Glib::ustring& > Settings::signal_changed(const Glib::ustring& key)
{
  return Glib::SignalProxyDetailed1< void,const Glib::ustring& >(this, &Settings_signal_changed_info, key);
}
