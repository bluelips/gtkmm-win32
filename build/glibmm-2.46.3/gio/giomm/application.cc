...
void Application::get_is_busy() const
{
  g_application_get_is_busy(const_cast<GApplication*>(gobj()));
}
...
Glib::SignalProxy0< void > Application::signal_shutdown()
{
  return Glib::SignalProxy0< void >(this, &Application_signal_shutdown_info);
}
