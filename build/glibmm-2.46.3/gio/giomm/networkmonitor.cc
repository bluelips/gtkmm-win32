...
{
  GError* gerror = nullptr;
  bool retvalue = g_network_monitor_can_reach(gobj(), const_cast<GSocketConnectable*>(Glib::unwrap(connectable)), 0, &(gerror));
  if(gerror)
    ::Glib::Error::throw_exception(gerror);
  return retvalue;
}
...
Glib::SignalProxy1< void,bool > NetworkMonitor::signal_network_changed()
{
  return Glib::SignalProxy1< void,bool >(this, &NetworkMonitor_signal_network_changed_info);
}
