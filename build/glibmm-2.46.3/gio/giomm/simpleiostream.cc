...
:
  ...
  Glib::ObjectBase(0),
  Gio::IOStream(Glib::ConstructParams(simpleiostream_class_.init(), "input_stream", const_cast<GInputStream*>(Glib::unwrap(input_stream)), "output_stream", const_cast<GOutputStream*>(Glib::unwrap(output_stream)), static_cast<char*>(0)))
{
