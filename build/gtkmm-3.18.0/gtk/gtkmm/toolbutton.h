...
public:
   ...
   * property only has an effect if not overridden by a non-<tt>0</tt> 
   * Gtk::ToolButton::property_label_widget() property. If both the Gtk::ToolButton::property_label_widget()
   * and Gtk::ToolButton::property_label() properties are <tt>0</tt>, the label is determined by the
   * Gtk::ToolButton::property_stock_id() property. If the Gtk::ToolButton::property_stock_id() property is
   * also <tt>0</tt>, @a button will not have a label.
   * 
   * @newin{2,4}
   * 
   ...
   * overridden by non-<tt>0</tt> Gtk::ToolButton::property_label_widget(), 
   ...
   * <tt>0</tt> the icon is determined by the Gtk::ToolButton::property_stock_id() property. If the
   * Gtk::ToolButton::property_stock_id() property is also <tt>0</tt>, @a button will not have an icon.
   * 
   * @newin{2,4}
   * 
   ...
   * for @a button. If @a label_widget is <tt>0</tt> the Gtk::ToolButton::property_label() property is used
   * as label. If Gtk::ToolButton::property_label() is also <tt>0</tt>, the label in the stock item
   * determined by the Gtk::ToolButton::property_stock_id() property is used as label. If
   * Gtk::ToolButton::property_stock_id() is also <tt>0</tt>, @a button does not have a label.
   * 
   * @newin{2,4}
   * 
