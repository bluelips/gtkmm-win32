...
/* QUEUE DRAWS */
   ...
   * @deprecated Use a custom style provider and style classes instead.
   * 
   * @param font_desc The font description to use, or <tt>0</tt> to undo
...
//  to avoid confusion with set_parent and set_style.
   ...
   * 
   * @param previous_parent The previous parent, or <tt>0</tt> if the widget
...
/** Enables or disables the emission of Gtk::Widget::signal_query_tooltip() on @a widget.
   ...
   * tooltip shown if the given string is not <tt>0</tt>: Gtk::Widget::property_has_tooltip()
...
/** Sets the text of tooltip to be the given string.
  ...
  /** The widget's window if it is realized, <tt>0</tt> otherwise.
   * 
   * @newin{2,14}
   *
   * @return A PropertyProxy_ReadOnly that allows you to get the value of the property,
