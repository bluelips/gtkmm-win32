...
/** The label for the link to the website of the program.
   ...
   * When setting this property to a non-<tt>0</tt> value, the
...
/** The license of the program, as a value of the Gtk::License enumeration.
  ...
  /** The authors of the program, as a <tt>0</tt>-terminated array of strings.
...
/** The authors of the program, as a <tt>0</tt>-terminated array of strings.
  ...
  /** The people documenting the program, as a <tt>0</tt>-terminated array of strings.
   * Each string may contain email addresses and URLs, which will be displayed
   * as links, see the introduction for more details.
   * 
   * @newin{2,6}
...
/** Credits to the translators. This string should be marked as translatable.
  ...
  /** The people who contributed artwork to the program, as a <tt>0</tt>-terminated
...
/** The people who contributed artwork to the program, as a <tt>0</tt>-terminated
  ...
  /** A logo for the about box. If it is <tt>0</tt>, the default window icon
