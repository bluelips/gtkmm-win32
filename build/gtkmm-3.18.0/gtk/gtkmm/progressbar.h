...
public:
   ...
   * 
   * If @a text is non-<tt>0</tt> and Gtk::ProgressBar::property_show_text() is <tt>true</tt>, the text
   ...
   * property or, if that is <tt>0</tt>, the Gtk::ProgressBar::property_fraction() value,
   * as a percentage.
   * 
...
/** The preferred place to ellipsize the string, if the progress bar does
   ...
   * to the empty string (not <tt>0</tt>).
   * 
   * @newin{3,0}
   *
   * @return A PropertyProxy that allows you to get or set the value of the property,
