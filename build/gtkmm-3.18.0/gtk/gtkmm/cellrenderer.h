...
public:
   ...
   * @param minimum_width Location to store the minimum size, or <tt>0</tt>.
   * @param natural_width Location to store the natural size, or <tt>0</tt>.
   */
   ...
   * 
   * @param widget The Gtk::Widget this cell will be rendering to.
   * @param minimum_height Location to store the minimum size, or <tt>0</tt>.
   * @param natural_height Location to store the natural size, or <tt>0</tt>.
   */
