...
:
  ...
  Glib::ObjectBase(0),
  Gtk::Button(Glib::ConstructParams(scalebutton_class_.init(), "size",static_cast<GtkIconSize>(int(size)),"icons",Glib::ArrayHandler<Glib::ustring>::vector_to_array(icons).data(),static_cast<char*>(0), static_cast<char*>(0)))
{
...
:
  // Mark this class as non-derived to allow C++ vfuncs to be skipped.
  Glib::ObjectBase(0),
  Gtk::Button(Glib::ConstructParams(scalebutton_class_.init(), "size",static_cast<GtkIconSize>(int(size)), static_cast<char*>(0)))
{
  auto adjustment = Adjustment::create(min, min, max, step, 10 * step, 0);
  set_adjustment(adjustment);
}
